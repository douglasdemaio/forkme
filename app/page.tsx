  ...
  return (
    <div className="page">
      ...
      <div className="text-center mb-8 pt-4">
        ...
        <p className="text-dark-300 mt-2">{t('home.subtitle')}</p>
      </div>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-dark-900 border border-dark-800 rounded-2xl pl-12 pr-4 py-3 text-white placeholder:text-dark-400 focus:outline-none focus:border-brand-500 transition-colors"
        />
        {search && (
          <button
